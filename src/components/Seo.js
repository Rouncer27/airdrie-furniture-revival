  ...
  const { site, siteLogo, defaultFb } = useStaticQuery(
    graphql`
      query {
        ...
        siteLogo: file(relativePath: { eq: "airdrie-furniture-revival.png" }) {
          publicURL
        }

        defaultFb: file(
          relativePath: { eq: "airdrie-furniture-revival-seo-meta-image.png" }
        ) {
          publicURL
        }
      }
  ...
  return (
    <>
      ...
      <SchemaOrg
        ...
        canonicalUrl=""
        author=""
        organization="Airdrie Furniture Revival"
        defaultTitle="Airdrie Furniture Revival"
      />
    </>
  )
}
