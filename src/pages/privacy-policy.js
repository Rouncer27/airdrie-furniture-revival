...
const PrivacyPolicy = props => {
  ...
  return (
    <Layout location={location}>
      <SEO
        title="Privacy Policy - Airdrie Furniture Revival"
      ...
      <PrivacyPolicyStyled>
        ...
        <div>
          ...
          <p>
            Your privacy is important to us. It is Airdrie Furniture Revival
          ...
          <p>
            ...
            information is protected and maintained. Airdrie Furniture Revival
            may change this privacy policy from time to time at Airdrie
            Furniture Revival sole discretion.
          </p>
          <p>
          ...
          <p>
            ...
            against the loss, misuse and interception by third parties. Airdrie
            Furniture Revival assumes no liability for interception, alteration
            or misuse of information transmitted over the Internet. Only
            employees who need the information to perform a specific job have
            access to personal information. Email transmission and messages sent
            via the internet can be accessed by other Internet users. If you
            want to keep certain information confidential you may contact us by
          ...
          <p>
            ...
            info@airdriefurniturerevival.com
          </p>
          <p>
            What about spam? You will not receive marketing e-mail from Airdrie
            Furniture Revival unless you have consented to receive it. From time
            to time we may use e-mail as a way to keep in touch with our
            existing customers and other interested individuals. However, we do
            not send ‘spam’ (unsolicited marketing e-mail). If you agree to
            receive e-mail communications from us, every e-mail message we send
            you will include an e-mail address to which you can respond. If at
            any time you decide you do not want to receive marketing e-mail from
            us, simply let us know and we will remove your name and e-mail
            address from our marketing lists. We will do the same with your
            mailing address and telephone number on request.
          </p>
          <p>
